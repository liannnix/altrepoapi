...
PRODUCT_CPE = {
    ...
    "c10f2": ["cpe:/o:alt:spworkstation:10", "cpe:/o:alt:spserver:10"]  # FIXME: how to distinguish 'c10f1' and 'c10f2'?
}
BRANCH_CHECK_REGEX = {
    ...
    "c10f2": (r"cpe:\/o:alt:sp(?:server|workstation):(\d+)", "10"),  # FIXME: how to distinguish 'c10f1' and 'c10f2'?
}
