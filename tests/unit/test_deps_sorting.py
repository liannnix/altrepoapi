...
TEST_FILE_RESULT_SORTED = "./tests/unit/deps_sorting_data/result_sorted"
TEST_FILE_RESULTS_CIRCLE = "./tests/unit/deps_sorting_data/result_circle"


class TestDepsSorting(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        with open(TEST_FILE_INPUT_STRUCT, "r") as fd:
    ...
    def test_sort_list(self):
        ...
        with open(TEST_FILE_RESULTS_CIRCLE, "r") as fd_c, open(
            TEST_FILE_RESULT_SORTED
        ) as fd_s:
    ...
    def test_search_circle_deps(self):
        ...
        with open(TEST_FILE_RESULTS_CIRCLE) as fd:
