...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"name": "getssl", "branch": "p10", "arch": None, "status_code": 200},  # source package deleted from branch
        {
            "name": BIN_PACKAGE_IN_DB,
            "branch": BRANCH_IN_DB,
            "arch": None,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"name": "getssl", "branch": "p10", "status_code": 200},  # source package deleted from branch
        {"name": "getssl", "branch": "sisyphus", "status_code": 200},  # source package deleted from branch
