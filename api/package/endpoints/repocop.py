...
class Repocop(APIWorker):
    ...
    def check_params_post(self):
        ...
        self.input_params = []
        self.known_param = ['pkg_name', 'pkg_version', 'pkg_release', 'pkg_arch', 'pkgset_name', 'rc_srcpkg_name', 'rc_srcpkg_version',
    ...
    def get(self):
        ...
        RepocopInfo = namedtuple('RepocopJsonModel', [
            'pkg_name', 'pkg_version', 'pkg_release', 'pkg_arch', 'branch',
